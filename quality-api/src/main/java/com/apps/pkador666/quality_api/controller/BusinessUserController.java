...
public class BusinessUserController {
  ...
  public ResponseEntity<ApiResponse<List<BusinessUser>>> findByBusinessId(@PathVariable("id") Long id) {
      return ResponseEntity.ok(ApiResponse.success(businessUserService.findByBusinessId(id), "Listado correcto"));
  }
